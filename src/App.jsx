...
function App() {
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-black md:bg-[url('https://www.solutions4it.co.uk/wp-content/uploads/2023/08/password-attacks.jpg')] font-WDXL">
